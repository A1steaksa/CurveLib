...
---@class CurveLib.Editor.Graph.Draggable.HandlePoint : CurveLib.Editor.Graph.Draggable.Base
...
function PANEL:OnDragged( x, y )
    local correctedX, correctedY = (self:GetParent() --[[@as CurveLib.Editor.Graph.Panel]]):OnHandlePointDragged( self, x, y )
...
vgui.Register( "CurveLib.Editor.Graph.Draggable.HandlePoint", PANEL, "CurveLib.Editor.Graph.Draggable.Base" )
